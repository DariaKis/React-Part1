            ...
            <div className="card__form">
                <div className="card__inner">
                    ...
                    <div className="card__textarea-wrap">
                        ...
                        <p className="card__text--comment">Curabitur aliquet quam id dui posuere blandit. Pellentesque
                            in ipsum id orci porta dapibus. Nulla quis lorem ut libero malesuada feugiat.</p>
                    </div>
